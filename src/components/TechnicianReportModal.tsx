        ...
        <form onSubmit={handleSave} className="flex-1 overflow-y-auto p-6 space-y-4">
          ...
          <div className="pt-4 border-t border-slate-800 flex items-center justify-between gap-3">
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-semibold text-slate-200 bg-slate-800 hover:bg-slate-700 border border-slate-700 transition"
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                type="submit"
                className="flex items-center gap-1.5 px-5 py-2 rounded-lg text-xs font-semibold text-white bg-emerald-600 hover:bg-emerald-500 transition shadow-lg shadow-emerald-600/25 active:scale-95"
              >
                <CheckCircle2 className="w-4 h-4" />
                <span>Salva Rapporto & Completa</span>
              </button>
            </div>
          </div>
